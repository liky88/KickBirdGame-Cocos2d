...
var GameLayer = cc.Layer.extend({
    ...
    ctor:function () {
        ...
        //分数
        this._score = new cc.LabelTTF("0","",50);//define a label to display the score
        this._score.setAnchorPoint(0,1);//set the anchor point at top left, e.g. (1,1): top right,(0,0): bottom left
        this._score.setPosition(10,size.height-10);
        this.addChild(this._score);//add the customized label to the frame
        ...
        //小鸟层
        //anything that gets drawn or contains things that get drawn is a cc.Node
        ...
        update:function(dt){
            ...
            if(this._step%20==0){
                ...
                //this._birdRect[Math.floor(Math.random()*4)]: read one of the birds's location
...
//first trigger here to start the game scene
